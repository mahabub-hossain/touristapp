...
//============================== COUNT DOWN =========================
  ...
  $('.incr-btn').on('click', function(e) {
      ...
      var rate = parseInt($(this).closest('.form-group').find('.original_quantity').val());
      var quantity = parseInt($(this).closest('.form-group').find('.quantity').val());
      var new_price = rate*quantity;
      $(this).closest('.form-group').find('.price').html(new_price);

      $('.totalCostRight').html(parseFloat($('.adult_price').html())+parseFloat($('.child_price').html()));
  });
