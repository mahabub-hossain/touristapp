...
//$a = \App\Helpers\SystemHelper::testMethod();
//echo $a;exit();
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @foreach($menuList as $key=>$menu)
                        ...
                        <li class="dropdown megaDropMenu <?php (\App\Helpers\SystemHelper::isActiveMenu($currentPath, $menuList[$key]))?'active':''?>">
                        ...
                        @else
                            ...
                            <?php
//                            $a = \App\Helpers\SystemHelper::isActiveMenu($currentPath, $menuList[$key]);
//                            print_r($a);
                            ?>
                                        ...
                                        <li class="dropdown dropdown-submenu">
                                            @if(is_array($layerOne['child']) && sizeof($layerOne['child'])>0)
                                                ...
                                                <ul class="dropdown-menu">
                                                    @foreach($layerOne['child'] as $layerTwo)
                                                        <li class=""><a
                                                                    href="{{$layerTwo['link']}}">{{$layerTwo['label']}}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                        @else
