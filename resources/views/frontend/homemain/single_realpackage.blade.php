...
@section('single_country_content')
    <?php
    $jsonString =$packageslug->packageimages;
    $decoded = json_decode($jsonString, true);

    if(is_array($decoded)){
     ?>
    <section class="pageTitle" style="background-image:url({{
                          asset('/images/'.$decoded[array_rand($decoded, 1)])
                          }});;">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                        ...
                        <div class="col-xs-12">
                            <div class="description-aria">
                                ...
                                <div class="information-aria">
                                    ...
                                    @foreach($packageslug->program as $program)
                            ...
                            <div class="location-aria">
                                ...
                                <div class="google-maps">
                                    ...
                                    <script>
                                        function initMap() {
                                            var myLatLng = new google.maps.LatLng(<?php echo $packageslug->lat . ',' . $packageslug->long; ?>);
                                        ...
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2 col-sm-12 col-xs-12">
                                                    <input class="original_quantity" type="hidden" value="{!! $packageslug->packageprice !!}">
                                                    <p class="price adult_price">{!! $packageslug->packageprice !!}</p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2 col-sm-12 col-xs-12">
                                                    <input class="original_quantity" type="hidden" value="{!! $packageslug->packageprice_child !!}">
                                            ...
                                            <div class="totalCost">
                                                ...
                                                <div class="col-xs-4 totalCostRight">TK. {!! $packageslug->packageprice !!}</div>
                                            </div>
                                            <div class="col-sm-12">
                ...
                @foreach($otherpackages as $otherpackage)
                    <div class="col-sm-6 col-lg-4 col-xs-12">
                        <div class="thumbnail deals">
                            <?php
                            $jsonString = $otherpackage->packageimages;
                            $decoded = json_decode($jsonString, true);
                            if(!NULL){
                            if(is_array($decoded)){
                            ?>
                            ...
                            ?>
                            <a href="{{url('/package/'.str_slug($otherpackage->packageslug,'-'))}}" class="pageLink"></a>
                            ...
                            <div class="caption">
                                <h4><a href="{{url('/package/'.str_slug($otherpackage->packageslug,'-'))}}" class="captionTitle">{{$otherpackage->packagename}}</a></h4>
                                <p>{!! str_limit($otherpackage->description, $limit =20, $end = '...')!!}</p>
                                <div class="detailsInfo">
                                    <h5>
                                        <span>Start From</span>
                                        ${{$otherpackage->packageprice}}
                                    </h5>
                                    <ul class="list-inline detailsBtn">
                                        <li><a href="{{url('/package/'.str_slug($otherpackage->packageslug,'-'))}}" class="btn buttonTransparent">Details</a></li>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            //     e.preventDefault();
            //     var price = parseInt($(this).closest('.form-group').find('.price').html());
            //     var quantity = parseInt($(this).closest('.form-group').find('.quantity').html());
            //     var new_price = price*quantity;
            //     $(this).closest('.form-group').find('.price').html('TK. '+new_price);
            // });
